...
どのような教育経験にも、ユニークな目標、メッセージ、条件、環境があります。ワークショップやクラスなど、p5.jsの教育リソースを文書化し共有することで、世界中のp5.js学習者と教育者のコミュニティをより良くつなげることを目指しています。[GitHub](https://github.com/processing/p5.js-website/blob/main/src/content/pages/en/education-resources.mdx?plain=1)で教育リソースを追加してください！

OSACC 2024で教育リソースリストを開始したTuan Huang、Yu Lee、Janis Sepúlvedaに感謝します。また、以前のp5.js Teachページの貢献者であるInhwa Yeom、Gracia Zhang、Qianqian Yeにも感謝します。
