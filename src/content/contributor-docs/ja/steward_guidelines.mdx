...
* [スチュワードシップ](steward_guidelines.md#stewardship)
  * [コミュニティケア](steward_guidelines.md#community-care)
  * [エリア](steward_guidelines.md#areas)
  * [スチュワードになるには](steward_guidelines.md#becoming-a-steward)
  * [スチュワードシップを始める](steward_guidelines.md#getting-started-with-stewardship)
...
## スチュワードシップ <a id="stewardship"></a>

### コミュニティケア <a id="community-care"></a>

オープンソースの精神には、[アクセシビリティ、教育、コラボレーション、透明性、主体性](https://www.opensourceethos.net/)が含まれます。私たちが一緒にコードを書く間、これらの価値観を実践するには、多くのコミュニティケアが必要です。これらは、スチュワードシップの定義の一部であるコミュニティケアの実践です：

1. **フレンドリーなコメント**や役立つ**コードレビュー**を通じて、新しいコントリビューターをGitHubに歓迎すること。
2. **機能に関する議論を促進**し、技術的な不一致を解決するのを助けること。例えば、過去の議論への関連付けを行ったり、以前の関連経験からの入力を提供したりすることを意味します。機能を提案したり、それに取り組んだりすることは、スチュワードシップではなくコントリビューションです。
3. バグ修正や機能の完成を**サポート**することで、p5.jsソフトウェアのリリースに参加すること。例えば、他のコントリビューターを指導し、彼らのPRをレビューすることを意味します。バグを修正することは、スチュワードシップではなくコントリビューションです。

これらのガイドラインの残りの部分では、p5.jsに効果的に貢献し、他者の貢献を役立つように導くためのヒントとコツを提供します。ここに書かれていることのほとんどは、特に明記されていない限りガイドラインであり、ワークフローに合わせてここで示されている実践を適応させることができます。

誰もができるときにコミュニティのスチュワードシップを助けるよう招待されています！コントリビューターが新しいコントリビューターを歓迎し、他者のコードをレビューし、API設計のフィードバックを提供するのを見るのは嬉しいことです。具体的な役割もいくつかあります：

1. コントリビューターは、Issue、PR、コメント、コードレビューを行うことができます。
2. メンテナーは、PRのマージやコードベースの他の部分の管理も行うことができます。

スチュワードもコントリビューターになることができます：彼らはコントリビューターとしてIssueやPRを作成できますが、特定のエリアをスチュワードしているときは、特に議論やレビューを手助けするために他のコントリビューターからタグ付けされた場合に、Issueにコメントしたりコードレビューを行ったりする責任も負います。

コントリビューターとして、p5.jsリポジトリのREADMEファイルで現在のスチュワードを確認し、関連するスチュワードをタグ付けすることができますが、オープンソースプロジェクトの技術的な作業のほとんどがボランティアであることを念頭に置き、忍耐と配慮を強調するコントリビューターガイドラインに留意してください。

スチュワードとして、あなたが担当するエリアであり、役立つガイダンスを提供できる場合は、自分が作成していないIssueやPRのコードレビューに定期的に参加してくれることを願っています！

### エリア <a id="areas"></a>

スチュワードが担当できるさまざまな作業エリアがあります。これらのエリアは、いくつか例外を除いて、ほとんどの場合GitHubラベルと一致します。以下はエリアのリストです。

* **Accessibility** (アクセシビリティ): これには、`describe(..)`のようなAPIによるスクリーンリーダーのサポートや、リファレンスWebサイトでのアクセシビリティサポートなど、デジタルおよびWebアクセシビリティが含まれます。
* **Core** (コア): レンダリングや環境を含む、主要なp5.js APIを指します。
* **DevOps**: ビルドプロセス、ユニットテスト、および開発体験のその他の側面を指します。
* **Documentation** (ドキュメント): Webサイトで公開されているコアコードベース内のリファレンス、コントリビュータードキュメント、およびその他のWebサイトコンテンツが含まれます。
* **i18n** (国際化 / **翻訳**): 翻訳のレビュー、特に`es`、`hi`、`ko`、`zh`を含みます。
* **Graphics** (グラフィックス): WebGLおよび[p5.strands](https://beta.p5js.org/tutorials/intro-to-p5-strands/)のサブエリアを含みます。
* **Color** (色): Color、ColorMode、色の使用に関するアクセシビリティの改善が含まれます。
* **Typography** (タイポグラフィ): テキストとフォントの処理に関するすべてのトピックを指します。
* **Math** (数学): 外部Math APIと内部パフォーマンス改善の両方が含まれます。
* **Shapes** (形): p5.jsの1.11.xおよび2.xバージョンの両方でのカスタムシェイプの操作が含まれます。
* **Maintainers** (メンテナー): このグループはPRをマージできます。
* **p5.sound.js**: [新しいp5.sound.js](https://github.com/processing/p5.sound.js)アドオンライブラリ。
* **p5.js-website**: [リファレンスWebサイト](https://p5js.org/)のコンテンツ以外の側面 - 例えば、その構造、自動化、技術的な改善など。

これらの重点分野は、プロジェクトのニーズに応じて時間の経過とともに変化する可能性があります - したがって、スチュワードに応募するプロセスを経ている場合は、新しいエリアを提案することを歓迎します！

### スチュワードになるには <a id="becoming-a-steward"></a>

スチュワードになるには2つの方法があります：

1. *指名*：メンテナーや他のスチュワードによる、Discord、Discourse、またはGitHub上での会話などでの指名。
2. *応募*：GitHub @ と提案するエリアを記載して`stewards.yml`を更新するPRを作成することによる応募。各エリアには1〜3人のスチュワードがいるべきであることを念頭に置いてください。私たちは常に**翻訳スチュワード**を探しています！応募PRを作成すると、他のメンテナーやスチュワードから、興味のあるエリアに関連するPRを作成したり、関連する議論に参加したりするなど、追加の補足資料を求められる場合があります。

スチュワードであり続けるためには、直近の2つのマイナーリリース（例：2.1.0または1.11.0 - 真ん中の数字が変わるとき）のうち少なくとも1つにスチュワードとして貢献する必要があります。これらはパッチ（例：2.0.3から2.0.4 - 右端の数字が変わるとき）ほど頻繁ではありません。実際には、スチュワードは4〜6ヶ月ごとにアクティブであり、コードを書く必要はなく、議論やコードレビューを通じて他のコントリビューターをサポートすることが期待されています。スチュワードシップを辞任するには、`stewards.yml`から自分自身を削除するPRを作成できます。いつでも一時停止して、将来再応募することを歓迎します！

### スチュワードシップを始める <a id="getting-started-with-stewardship"></a>

1. このガイドラインを参照として手元に置いてください - 新しいIssue、バグ、機能をどのように支援するか。例えば、「機能リクエスト」セクションには、スチュワードとしてp5.jsの[アクセスステートメント](../access/)を使用する方法に関するヒントが含まれています。
2. 技術的な質問に答えたりレビューしたりするのを手伝うときは、Processing Foundationの[質問への回答に関するガイドライン](https://discourse.processing.org/t/guidelines-answering-questions/2145/)を適用してみてください - これらは建設的な技術的フィードバックを提供するのに特に役立ちます。
3. [p5.js Discord](https://discord.com/invite/SHQ8dH25r9/)に参加してください - `#contribute-to-p5`では、このプロセスについて質問したり、改善方法を提案したりすることを歓迎します！
